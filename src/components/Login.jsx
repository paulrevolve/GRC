            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  onKeyDown={handleKeyDown}
                  disabled={loading}
                  className="w-full h-12 rounded-xl bg-[#132F3B] border border-[#21414D] px-4 pr-12 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400"
                />

                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 cursor-pointer top-1/2 -translate-y-1/2 text-gray-400 focus:outline-none"
                  tabIndex={-1}
                >
                  {showPassword ? (
                    // Eye Off Icon (Hide)
